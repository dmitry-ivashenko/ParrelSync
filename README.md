...
```
https://github.com/dmitry-ivashenko/ParrelSync.git?path=/ParrelSync
```  
...
```
"com.veriorpies.parrelsync": "https://github.com/dmitry-ivashenko/ParrelSync.git?path=/ParrelSync"
``` 
